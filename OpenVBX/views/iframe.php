...
<head>
	...
	<link rel="stylesheet" href="<?php echo asset_url('assets/c/jquery-ui.min.css'); ?>" type="text/css" media="screen" />
<?php if ($this->config->item('use_unminimized_js')): ?>
	<script type="text/javascript" src="<?php echo asset_url('assets/j/frameworks/jquery-2.1.3.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo asset_url('assets/j/frameworks/jquery-ui.min.js'); ?>"></script>
