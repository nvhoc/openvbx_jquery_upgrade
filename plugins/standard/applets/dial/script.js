$(document).ready(function(){
	...
	$(app).on('usergroup-selected',".dial-applet .usergroup-container",  function(e, usergroup_label, type){
	...
	$(app).on('change',".dial-applet input.dial-whom-selector-radio", function (e) {
	...
	$(app).on('click',".dial-applet input.no-answer-action-radio,.dial-applet input.dial-whom-selector-radio,.dial-applet input.dial-whisper-radio", function(event) {
