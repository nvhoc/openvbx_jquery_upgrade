...
$(document).ready(function() {
	...
	$('body').on('keyup','.quick-sms-popup input[name="content"]', updateCount);
	$('.quick-sms-popup input[name="content"]').keypress();
	$('#reply-sms').on('keyup','textarea', updateCount);
	$('#reply-sms').on('keyup','textarea', updateCount);
	...
	$('body').on('click','.assign-user-list .user a', function(event) {
		event.preventDefault();
		var anchor = $(this);
