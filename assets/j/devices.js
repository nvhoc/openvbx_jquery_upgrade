...
$(document).ready(function() {
	...
	$('body').on('click','.email-button', openEmailDialog);

	$('body').on('click','.add-device', openNumberDialog);
	...
	$('body').on('click','.device-status a.on', function(event) {
		toggleEnableDeviceValue(event, this);
	});
	$('body').on('click','.device-status a.off', function(event) {
		toggleEnableDeviceValue(event, this);
	});

	$('body').on('change','.enable-sms', function(event) {
		event.preventDefault();
	...
	$('body').on('change','.device-status .enable-device', function(event) {
	...
	$('body').on('click','.device .edit', function(event) {
		event.preventDefault();
	});

	$('body').on('click','.device .trash', function(event) {
		event.preventDefault();
