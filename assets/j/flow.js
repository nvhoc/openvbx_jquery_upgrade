...
Flows.initialize = function() {
	...
	$('body').on('click','.navigate-away, .util-menu a, .close-button', function(e) {
		if($(this).attr('href') != '') {
	...
	$('body').on('click','.timing-timerange-wrap a', function(e) {
		e.preventDefault();
		e.stopPropagation();
	...
	$('body').on('click','#flow-rename, .flow-name, #flow-rename-cancel', function(e) {
		e.stopPropagation();
		e.preventDefault();
		var $this = $(this);
	...
	$('body').on('show','.flow-instance', Flows.events.flow.shown);
	$('body').on('hide','.flow-instance', Flows.events.flow.hidden);
	$('body').on('click','.flow-instance', Flows.events.flow.select);
	$('body').on('set-name','.flow-instance', Flows.events.flow.setName);
	$('body').on('click','.flow-instance .close-flow-instance', Flows.events.flow.close);
	$('body').on('click','.flow-instance .flowline-item-remove', Flows.events.drop.remove);
	...
	$('body').on('submit','.vbx-form', preventDefault);
	$('.vbx-form :input, .flow-name-edit :input').change(function() {
		Flows.modified = true;
	});
	
	$('body').on('click','.view-source', function(e) {
		e.stopPropagation();
		e.preventDefault();
