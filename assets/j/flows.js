...
$(document).ready(function() {
	...
	// edit flow name
	$('body').on('click','.flow-name-display', function(event) {
		event.stopPropagation();
		$(this).hide()
			.siblings('.flow-name-edit').show();
	});
	$('body').on('click','.flow-name-edit-cancel', function(event) {
		event.preventDefault();
		event.stopPropagation();
		var $this = $(this);
	...
	$('body').on('click','.flow-name-edit button.submit-button', function(event) {
		event.stopPropagation();
		event.preventDefault();
		var $this = $(this);
